...
export async function analyzeTreasuryDecision(question, context) {
    ...
    return context.treasuryAnalysisService.analyze(context.userId, question, context.knownFacts ?? {});
}
export async function analyzeRetailDecision(question, context) {
...
export function classifyFinanceIntent(question) {
...
export async function financeDecisionAgent(question, context) {
