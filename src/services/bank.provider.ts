import { AccountBalancesTable, CreditProfileTable, FinancialSummaryMonthlyTable, InvestmentSummaryTable, LoanAccountsTable } from "../db/schema/structured_finance_data.js";
...
export type OBFinancialActivityDTO =
  | OBTransactionActivity
  | OBInvestmentActivity;



export interface IBankProvider{
    name: string;
    fetchTransactions(connectionId: string, fromDate: String | null): Promise<OBBaseFinancialActivity[]>;
    fetchStructuredFinancialData(connectionId: String): Promise<StructuredFinancialData>
