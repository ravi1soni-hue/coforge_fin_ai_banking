...
const buildAffordabilityReasoningAnswer = (
  ...
  const purchaseLabel = (() => {
    ...
    if (goalType === "phone" || goalType === "smartphone") return "this phone";
    if (goalType === "car" || goalType === "vehicle" || goalType === "automobile") return "this car";
    if (goalType === "bike" || goalType === "motorcycle") return "this bike";
    if (goalType === "house" || goalType === "property" || goalType === "mortgage") return "this property";
    if (goalType === "appliance") return "this appliance";
    if (goalType === "education" || goalType === "course") return "this course";
    if (goalType === "wedding") return "this wedding";
    if (goalType === "medical") return "this procedure";
    if (goalType === "trip" || goalType === "vacation" || goalType === "holiday" || goalType === "travel") return "this trip";
    return "this";
  })();
  ...
  if (comparableCosts.length >= 2) {
    ...
    const goalLabel =
      goalType === "trip" || goalType === "vacation" || goalType === "holiday" || goalType === "travel"
        ? "trip"
