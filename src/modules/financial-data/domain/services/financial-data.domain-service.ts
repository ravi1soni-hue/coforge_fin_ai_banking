...
export class FinancialDataDomainService {
   ...
   */
  calculateMonthlyExpenses(subscriptions: Subscription[]): number {
   ...
   */
  calculateTotalInvestments(investments: Investment[]): number {
   ...
   */
  calculateTotalDebt(loans: Loan[]): number {
   ...
   */
  calculateSavingsRate(user: User, subscriptions: Subscription[]): number {
